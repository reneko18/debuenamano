								...
								<ul>
										...
										<ul class="sub-menu mega-menu mega-menu-column-5">
											<li><a href="javascript:void(0)" class="mega-column-title">Home Group</a>
												<ul class="mega-sub-menu">
													<li><a href="index-trending.html">Trending</a><img src="{{ url('lezada/images/home-preview/01.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-collection.html">My collection</a><img
															src="{{ url('lezada/images/home-preview/02.jpg')}}" class="img-fluid" alt=""></li>
													<li><a href="index-special.html">Special</a><img src="{{ url('lezada/images/home-preview/03.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-concept.html">concept</a><img src="{{ url('lezada/images/home-preview/04.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-smart.html">smart design</a><img src="{{ url('lezada/images/home-preview/05.jpg')}}"
															class="img-fluid" alt=""></li>
												</ul>
											</li>
											<li><a href="javascript:void(0)" class="mega-column-title">Home Group</a>
												<ul class="mega-sub-menu">
													<li><a href="index-furniture.html">Furniture </a><img src="{{ url('lezada/images/home-preview/06.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-essentials.html">Essentials</a><img src="{{ url('lezada/images/home-preview/07.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-lookbook.html">Lookbook</a><img src="{{ url('lezada/images/home-preview/08.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-wearables.html">Wearables</a><img src="{{ url('lezada/images/home-preview/09.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-accessories.html">Accessories</a><img
															src="{{ url('lezada/images/home-preview/10.jpg')}}" class="img-fluid" alt=""></li>
												</ul>
											</li>
											<li><a href="javascript:void(0)" class="mega-column-title">Home Group</a>
												<ul class="mega-sub-menu">
													<li><a href="index-shoppable.html">Shoppable</a><img src="{{ url('lezada/images/home-preview/11.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-fashion.html">Fashion</a><img src="{{ url('lezada/images/home-preview/13.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-perfumes.html">Perfumes</a><img src="{{ url('lezada/images/home-preview/14.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-cosmetics.html">Cosmetics</a><img src="{{ url('lezada/images/home-preview/15.jpg')}}"
															class="img-fluid" alt=""></li>
													<li><a href="index-decor.html">Home Decor</a><img src="{{ url('lezada/images/home-preview/16.png')}}"
															class="img-fluid" alt=""></li>
												</ul>
											</li>
											<li><a href="javascript:void(0)" class="mega-column-title">Home Group</a>
												<ul class="mega-sub-menu">
													<li><a href="index-creative.html">Creative</a><img src="{{ url('lezada/images/home-preview/17.png')}}"
															class="img-fluid" alt=""></li>
												</ul>
											</li>
											<li>
												<div class="menu-image">
													<img src="{{ url('lezada/images/menu-image/menu-element.png')}}" class="img-fluid" alt="">
												</div>
											</li>
										</ul>
									</li>
									<li class="menu-item-has-children"><a href="shop-left-sidebar.html">Shop</a>
										<ul class="sub-menu mega-menu mega-menu-column-4">
											...
											<li>
												<div class="menu-image">
													<img src="{{ url('lezada/images/menu-image/megamenu-shop.png')}}" class="img-fluid" alt="">
												</div>
											</li>
										</ul>
									</li>
