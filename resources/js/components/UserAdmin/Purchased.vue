...
const products = ref([]);
const emit = defineEmits(["update-products-purchased-count"]);
...
const fetchData = async (user_id) => {
    try {
        const response = await axios.get(`/api/table/purchase/${user_id}`);
        ...
        emit("update-products-purchased-count", productsCount.value);
    } catch (error) {
