<template>
    <div class="modulo-resumen">
                ...
                <div class="row-child-dim">
                    <div class="col-dim">
                        ...
                        <input
                            ...
                            placeholder="0,0"
                            id="long-pro"
                            v-model="formData.stepThreeLong"
                        />
                    </div>
                    <div class="col-dim">
                        ...
                        <select
                            id="unl-pro"
                            class="form-select"
                            v-model="formData.stepThreeLongUnit"
                        >
                            <option selected>Seleccione</option>
                            <option value="cm">cm</option>
                            <option value="in">in</option>
        ...
        <h4>Región</h4>
        <p>{{ formData.stepSevenRegion }}</p>
        <h4>Comuna</h4>
        <p>{{ formData.stepSevenCity }}</p>
        <h4>Precio</h4>
        <p>{{ formData.stepEightPrice }}</p>
        ...
        <button class="btn btn-lg btn-primary" @click="submitForm">
            Enviar Datos
        </button>
    </div>
</template>
