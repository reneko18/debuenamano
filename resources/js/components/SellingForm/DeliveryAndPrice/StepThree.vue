    ...
    <div class="modulo-pasos">
            <div class="row">
                <div class="col-lg-7 col-md-12">
                    <h2>Una vez que compren tu artículo ¿A que cuenta te depositamos el pago?.</h2>
                    <p class="bajada-h2">Define el precio de venta de tu articulo considerando la comisión de DBM.</p>
                </div>
            </div>
            <div class="row col-md-11 mx-auto">
                <div class="col">
                    <div>
                        <label for="infoPayName" class="form-label">Nombre y apellido</label>
                        <input type="text" class="form-control" id="infoPayName" placeholder="Nombre y Apellido" v-model="formData.stepEightName">
                    </div>
                    <div>
                        <label for="infoPayBank" class="form-label">Banco</label>
                        <select id="infoPayBank" class="form-select" v-model="formData.stepEightBank">
                            ...
                            <option value="La Polar Prepago">La Polar Prepago</option>
                            <option value="Global66">Global66</option>
                        </select> 
                    </div>
                    <div>
                        <label for="infoPayAccountNumber" class="form-label">Nº de cuenta</label>
                        <input type="text" class="form-control" id="infoPayAccountNumber" placeholder="" v-model="formData.stepEightBankNumber">
                    </div>
                </div>
                <div class="col">
                    <div>
                        <label for="infoPayRut" class="form-label">Rut</label>
                        <input type="text" class="form-control" id="infoPayRut" placeholder="Rut" v-model="formData.stepEightRut" @input="formatAndValidateRUT">
                        <div v-if="isValidRUT" class="text-success">Valid RUT</div>
                        <div v-else class="text-danger">Invalid RUT</div>
                    </div>
                    <div>
                        <label for="infoPayTypeAccount" class="form-label">Tipo de cuenta</label>
                        <select id="infoPayTypeAccount" class="form-select" v-model="formData.stepEightBankType">
                    ...
                    <div>
                        <a href="#">
                            <svg version="1.1" id="cardSellingForm" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                viewBox="0 0 22 16" xml:space="preserve">
                                <path class="st0" d="M18.5,1H2.8C1.8,1,1,1.8,1,2.8v10.5c0,1,0.8,1.8,1.8,1.8h15.8c1,0,1.8-0.8,1.8-1.8V2.8C20.3,1.8,19.5,1,18.5,1z
                                    "/>
...
export default {
  ...
  methods: {
        formatAndValidateRUT() {
            ...
            let rut = this.formData.stepEightRut.replace(/[^\dKk]/g, "").toUpperCase();
            ...
            this.formData.stepEightRut = rut;
            ...
            if (expectedVerificationDigit === 11) {
                ...
                this.isValidRUT = parseInt(verificationDigit, 10) === expectedVerificationDigit;
            }
        },
    },
