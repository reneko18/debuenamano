<template>
        <div class="container mx-auto">
            <div class="row">
                <div class="col">
                    ...
                    <select id="cat-blog" class="form-select" aria-label="Default select example" v-model="selected.postcategories">
                        <option value="">Todas las categorias</option>
                        <option :value="pcat.id" v-for="pcat in postscats">{{ pcat.name }}</option>
                    </select>
                </div>
                <div class="col">
                    <label for="aut-blog" class="mb-3">Autores</label>
                    <select id="aut-blog" class="form-select" v-model="selected.authors">
                        <option value="">Todos los autores</option>
                        <option :value="aut.id" v-for="aut in authors">{{ aut.firstname }} {{ aut.lastname }}</option>
                    </select>
                </div>
                <div class="col">
                    <label for="order-blog" class="mb-3">Ordenar por</label>
                    <select id="oder-blog" class="form-select" aria-label="Default select example">
        ...
        <div class="row row-post-loop container mx-auto">
                ...
                <Bootstrap5Pagination :data="posts"  @pagination-change-page="loadPosts"/>
